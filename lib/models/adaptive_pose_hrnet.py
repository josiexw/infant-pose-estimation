...
class DomainClassifier(nn.Module):
    ...
    def __init__(self, feature_output):
        ...
        self.conv_layer = nn.Sequential(
            nn.Conv2d(48, 32, kernel_size=3, stride=1),     # no padding with bias
    ...
    def forward(self, feature_output):
        ...
        out = self.layer(x.view(-1, 8 * 22 * 16))
        return out
...
def get_adaptive_pose_net(cfg, is_train, **kwargs):
    model_p = PoseHighResolutionNet(cfg, **kwargs)
